package day09_0211.reflectionEx;
...
public class PersonMain {
    public static void main(String[] args) throws Exception {
        ...
        Class<Person> personClass =(Class<Person>) Class.forName("day09_0211.reflectionEx.Person");
        ...
        int privatePesult = (int) privateTotal.invoke(new Person(),200,300);

        System.out.println(privatePesult);
